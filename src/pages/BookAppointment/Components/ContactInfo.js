...
export default function ContactInfo({ handlePhoneNumChange, handleChange, values}) {
    ...
    return (
        <form autoComplete='off' >
            ...
            <br></br><br></br>
            <MuiPhoneNumber className='phoneNum' defaultCountry='us' disableAreaCodes onChange={handlePhoneNumChange} error={values.errors.phoneNumber} defaultValue={values.phoneNumber} />
